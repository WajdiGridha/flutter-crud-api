...
class _MyHomePageState extends State<MyHomePage> {
        ...
        child: new Center(
          ...
          builder: (context, snapshot) {
            return employeesList.length > 0
                ? new EmployeesList(employees: employeesList)
                : new Center(
  ...
  Future loadList() {
    Future<List<Employees>> futureEmployees = api.getEmployees();
    futureEmployees.then((casesList) {
      setState(() {
